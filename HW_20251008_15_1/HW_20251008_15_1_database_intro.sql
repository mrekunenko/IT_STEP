...
--
-- Зміст завдання з PDF:
-- 1. Створити базу даних Birds.
-- 2. Перейменувати її на Cats.
-- 3. Видалити базу Cats.
-- 4. Створити однотабличну базу даних "Овочі та фрукти"
--    (зберігати: назва, тип, колір, калорійність, опис).
-- 5. Написати вибірки даних з цієї таблиці.
--
-- Примітка:
-- Запити розраховані на PostgreSQL.
-- Деякі команди (типу ALTER DATABASE / DROP DATABASE)
-- не можна виконати всередині самої бази, яку ви перейменовуєте/видаляєте.
-- У pgAdmin або psql потрібно переключатися між базами.
-- =====================================================================
...
-- Підключення до бази (у psql виконується вручну, не вставляється в файл):
-- \c fruits_vegetables;
